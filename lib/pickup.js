...
function buildRequestData(data) {
    ...
    response += "<RatePickupIndicator>N</RatePickupIndicator>";
    response += "<TaxInformationIndicator>N</TaxInformationIndicator>";
    ...
    response += "<AlternateAddressIndicator>N</AlternateAddressIndicator>"
